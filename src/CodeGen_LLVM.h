...
private:
    ...
    /** List of unterminated BasicBlocks generated by IfThenElse.
     * We don't want to generate multiple terminators for a BasicBlock. */
    std::set<llvm::BasicBlock *> unterminated_branches;
